...
export default function Cart ({ setShowCart, showCartFn, showCart, userIDString })  {
  ...
  const router = useRouter();
    ...
    // if(newArray?.length > 0) toast.info('Click on the cart icon at the top right to view your items', {autoClose: 700 , position: "top-left"})
    ...
    return (
        <div className="relative z-10">
            <div className="cart relative flex-end" onClick={() => showCartFn()}>
                ...
                <div className={`w-5 h-5 flex items-center rounded-full justify-center border -right-3 absolute -top-2  border-white bg-[#695acd] text-white `}>
